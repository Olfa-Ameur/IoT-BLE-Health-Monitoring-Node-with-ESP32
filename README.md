...
The project also includes BLE packet analysis using Wireshark and an nRF51 dongle, enabling deep understanding of BLE communication.
##⚙️ Features
